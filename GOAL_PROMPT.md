...
> **Status: PROPOSED / M2–M6 IN PROGRESS.** Future-work contract, not an execution record.
...
| Evidence | M0/M1, T-023–T-025, and bounded T-030–T-033 verified; 60 tests pass |
| Verification | Prompt/documentation only |
| Limitations | Parser, public API, CI, and release remain open |

Work on `agent-cfml-linkage`, the Node `>=20` CFML-first static linkage prototype. M0/M1, bounded M2 extraction, T-023–T-025 index/path/Graph IR, T-030 CFC, T-031 scope, T-032 web-flow, and T-033 dynamic evidence are verified; private package/CLI exist, but no full parser, broader runtime, public API, CI, or release. Core SSOT: `GOAL.md`, `DESIGN.md`, `SPEC.md`, `EPIC.md`, `ROADMAP.md`, `TASK.md`, `PROGRESS.md`.
