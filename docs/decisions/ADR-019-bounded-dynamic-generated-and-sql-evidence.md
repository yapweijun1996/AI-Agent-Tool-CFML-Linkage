...
- `npm test` reports 74 passed; syntax, JSON/manifest, Markdown-link, prompt-length, conservative credential-pattern, and diff checks remain required repository gates.
