...
- `npm test` reports 75 passed; syntax, JSON/manifest, Markdown-link, prompt-length, conservative credential-pattern, and diff checks remain required repository gates.
