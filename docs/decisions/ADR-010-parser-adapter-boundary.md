...
| Evidence | `npm test`: 79 passed, including unavailable backend, bounded scanner tags/opaque regions, invalid encoding, partial output, backend failure, limits, and no-execution cases |
