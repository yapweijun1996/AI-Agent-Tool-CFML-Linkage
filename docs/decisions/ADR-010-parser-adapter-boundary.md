...
| Evidence | `npm test`: 62 passed, including unavailable backend, bounded scanner tags/opaque regions, invalid encoding, partial output, backend failure, limits, and no-execution cases |
