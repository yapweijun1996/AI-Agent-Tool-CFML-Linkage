...
| Evidence | `npm test`: 55 passed, including key-order fingerprints, add/change/remove detection, stale contexts, atomic replacement, corruption, and path-boundary cases |
