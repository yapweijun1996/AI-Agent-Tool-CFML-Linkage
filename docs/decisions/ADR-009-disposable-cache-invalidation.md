...
| Evidence | `npm test`: 60 passed, including key-order fingerprints, add/change/remove detection, stale contexts, atomic replacement, corruption, and path-boundary cases |
