...
| Evidence | `npm test`: 79 passed; literal fixtures resolve deterministically, vanished snapshot targets remain unresolved, and unsafe/dynamic/ambiguous paths remain explicit |
