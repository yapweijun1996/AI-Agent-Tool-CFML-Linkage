...
| Evidence | `npm test`: 76 passed; literal fixtures resolve deterministically, vanished snapshot targets remain unresolved, and unsafe/dynamic/ambiguous paths remain explicit |
