...
- `npm test` reports 75 passed; the query module re-copies even snapshot-shaped input before freezing, validates bounded request arrays, is syntax-checked, and uses no third-party dependency or runtime/service access.
