...
- `test/scope-resolver.test.js` covers ordered production, consumption, overrides, dynamic preservation, missing include coverage, Graph edge materialization, and include-depth/event/output resource bounds; the full `npm test` suite reports 79 passed.
