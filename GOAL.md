...
> **Status: PROPOSED / M2–M5 IN PROGRESS.** This goal describes the intended product outcome; the M1 safety foundation, bounded M2 parser/scanner/Fact slices, bounded M3 path/Graph slices, and bounded M4 CFC, M5 scope, and bounded web-flow/condition resolution are implemented/verified, but full linkage resolution is not implemented.
...
| Verification | M1 foundation, bounded M2 CFML/web parser/scanner/Fact extraction, bounded M3 resolution/Graph IR, bounded M4 CFC resolution, bounded M5 scope/web-flow resolution, and 59 focused Node tests pass locally; linkage/runtime/package-release verification is absent |
