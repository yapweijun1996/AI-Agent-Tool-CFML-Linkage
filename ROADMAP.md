...
| Focused tests | T-010–T-014/T-020–T-036/T-040/T-041/T-045/T-046/T-048/T-049 verified | `npm test`: 76 passed |
...
- M8: cache invalidation, bounded concurrency, hard resource limits, repeatability, and snapshot drift handling; T-040/T-041 verify the bounded repeat/drift/cache/cycle/limit and adversarial safe-failure subset, T-048 verifies the library evidence budget, T-049 verifies the final Graph edge budget, and the private CLI enforces serialized output limits, while library output and wall-time budgets remain open.
- M9: package/library/CLI smoke, golden and adversarial suites, documentation synchronization, and separately evidenced Lucee/Adobe compatibility; T-042 verifies local checks/package smoke, T-043 records Node host evidence, and T-036/T-045/T-046 provide bounded composition, query-command integration, and CLI configuration enforcement; T-047 provides the unverified CI workflow, T-049 adds bounded Graph edge-budget evidence, while broader compatibility and graph persistence remain open; T-037–T-039 remain reserved without executable definitions.
