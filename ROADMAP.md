...
| Verification | M0 contract gate, T-010–T-014/T-020–T-036/T-040/T-041 foundation/scanner/Fact/index/resolution/Graph/CFC/scope/web-flow/dynamic-evidence/SQL-repository/query/orchestration/robustness/adversarial-fixture tests, T-042 bounded contract/check/package smoke, T-043 bounded Node host compatibility, and produced Fact/Graph/analysis IR schema validation are verified; later milestones have no evidence |
...
| Focused tests | T-010–T-014/T-020–T-036/T-040/T-041 verified | `npm test`: 73 passed |
...
- M7: bounded `related`, `callers`, `callees`, `includes`, `included-by`, `trace`, `scope-flow`, `tables`, `routes`, `unresolved`, `explain-edge`, `impact-evidence`, and `stats` queries plus composed analysis output; T-035/T-036 are verified for the immutable query engine and bounded private composition.
