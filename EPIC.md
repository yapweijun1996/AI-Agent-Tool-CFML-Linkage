...
Current blocker: there is no implementation baseline. Before coding, the project must settle the Graph IR/Fact IR schema, parser strategy, supported syntax subset, configuration format, and test fixtures.
