...
| Verification | Guidance is exercised by the private M1 foundation, bounded M2 extraction, bounded M3–M8 resolvers/Graph/query/robustness boundary, bounded SQL/repository resolver, and 65 focused Node tests; full analyzer verification is absent |
