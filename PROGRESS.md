...
| Graph queries/evidence explanations | Yes | Partial | Partial | No | `src/graph-query.js`, `test/graph-query.test.js`, ADR-021; validated/copied immutable snapshots, exact selectors, declared bounded operations, deterministic explanations, traversal limits, and ambiguity behavior pass; query-command CLI wiring remains open |
