...
| Determinism/cache/cycle/limit robustness | Yes | Partial | Partial | No | `test/snapshot.test.js`, `test/cache.test.js`, `test/graph-query.test.js`, `test/analyzer.test.js`, and resolver/scanner limit cases; repeatability, content drift, cache invalidation/corruption, parser-time drift, cycle safety, and bounded-result evidence pass; full output/time budgets remain open |
...
7. **M8 partial:** T-040/T-041 verify bounded repeatability, content drift, cache invalidation/corruption, cycle safety, resource limits, and inert adversarial safe-failure fixtures; T-036 adds parser-time drift evidence, while full output/time budgets remain open.
